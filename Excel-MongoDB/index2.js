...
xlsx('Salary.xlsx',function(err,wb){                             //Reading the excel file
	...
	for(var i = 0; i<sheetNames.length;i++) {                    //looping for the sheetname
	 (function(i) {                                              //anonymous function
	  
	  setTimeout(storesheet(wb,sheetNames[i]),0);                //setTimeout executes storesheet without delay 
	 })(i);
	}
...
var storesheet=function(wb,sheetName){                          //stores the sheet data to mongodb
